    ...
    <View className="bg-[#00CCBB] flex-1 ">
      <SafeAreaView className="z-50">
        <View className="flex-row justify-between items-center p-5 mt-4 ">
          <TouchableOpacity onPress={() => navigation.navigate("FoodDel")}>
      ...
      <MapView
        ...
        className="flex-1 z-0 -mt-5" mapType="mutedStandard">
          <Marker
          coordinate={{
            latitude: restaurant.lat,
            longitude: restaurant.long,
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-20" >
        ...
        <Text className="text-[#00CCBB] text-lg mr-5 font-bold ">Call
        </Text>
      </SafeAreaView>
    </View>
  );
